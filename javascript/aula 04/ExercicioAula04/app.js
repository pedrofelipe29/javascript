...
const my3FavoriteTVShows = ['velozes e furiosos', 'harry potter', 'batman']
const sentence = `meus 3 filmes favoritos são: ${my3FavoriteTVShows[0]},  ${my3FavoriteTVShows[1]} e ${my3FavoriteTVShows[2]}`;
...
const isRandomTVShowIncluded = 'harry potter'
...
console.log(isRandomTVShowIncluded.includes(randomTVShow))
...
typeSentence.replace('TIPO_DE_DADO', typeof isRandomTVShowIncluded)
...
let NumChar = 39
console.log(`A string que a "typeSentence" armazena tem mais de ${NumChar} caracteres? ${typeSentence == NumChar}.`)
...
console.log(`o tipo de "randomShow"eh:   ${isNotAString}`)
...
let verifynumber = evenNumbers.includes(8)
