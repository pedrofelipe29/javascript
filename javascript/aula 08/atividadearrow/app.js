...
console.log(resultado);
  ...
  */
    ...
    console.log(randomNumbers.filter(isPositive));
  ...
  */
      ...
      const getOddNumbers = (numbers) => numbers.filter(number => number % 2 !== 0);
  ...
  */
  ...
  const array1 = functions.map(functions => functions()).join(' ')
  console.log(array1)
